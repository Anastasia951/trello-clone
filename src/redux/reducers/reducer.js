...
import { ADD_TASK, CHANGE_TASK, CHANGE_TITLE, CREATE_NEW_LIST, DELETE_TASK, DELETE_TITLE, SWAP_COLUMNS, UPDATE_TASKS, UPDATE_TASKS_FROM_DIFFERENT_LISTS } from "../constants"
...
export function reducer(state = initialState, { type, payload }) {
  switch (type) {
    ...
    case DELETE_TITLE: {
      const oldLists = state.lists.filter(list => list.id !== payload)
      return {
        ...state,
        lists: oldLists
      }
